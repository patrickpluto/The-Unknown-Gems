...
public class EalfenSwordItem extends TheUnknownGemsModElements.ModElement {
	@ObjectHolder("the_unknown_gems:ealfen_sword")
	public static final Item block = null;
	public EalfenSwordItem(TheUnknownGemsModElements instance) {
		super(instance, 72);
	}
