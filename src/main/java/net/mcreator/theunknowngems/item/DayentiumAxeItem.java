...
public class DayentiumAxeItem extends TheUnknownGemsModElements.ModElement {
	@ObjectHolder("the_unknown_gems:dayentium_axe")
	public static final Item block = null;
	public DayentiumAxeItem(TheUnknownGemsModElements instance) {
		super(instance, 8);
	}
