...
public class EalfenHoeItem extends TheUnknownGemsModElements.ModElement {
	@ObjectHolder("the_unknown_gems:ealfen_hoe")
	public static final Item block = null;
	public EalfenHoeItem(TheUnknownGemsModElements instance) {
		super(instance, 74);
	}
