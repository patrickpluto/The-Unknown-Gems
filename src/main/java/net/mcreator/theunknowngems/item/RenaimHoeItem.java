...
public class RenaimHoeItem extends TheUnknownGemsModElements.ModElement {
	@ObjectHolder("the_unknown_gems:renaim_hoe")
	public static final Item block = null;
	public RenaimHoeItem(TheUnknownGemsModElements instance) {
		super(instance, 53);
	}
