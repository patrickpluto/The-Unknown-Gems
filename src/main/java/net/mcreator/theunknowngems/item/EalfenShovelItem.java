...
public class EalfenShovelItem extends TheUnknownGemsModElements.ModElement {
	@ObjectHolder("the_unknown_gems:ealfen_shovel")
	public static final Item block = null;
	public EalfenShovelItem(TheUnknownGemsModElements instance) {
		super(instance, 73);
	}
