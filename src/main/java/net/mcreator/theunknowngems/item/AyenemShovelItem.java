...
public class AyenemShovelItem extends TheUnknownGemsModElements.ModElement {
	@ObjectHolder("the_unknown_gems:ayenem_shovel")
	public static final Item block = null;
	public AyenemShovelItem(TheUnknownGemsModElements instance) {
		super(instance, 31);
	}
