...
public class AyenemSwordItem extends TheUnknownGemsModElements.ModElement {
	@ObjectHolder("the_unknown_gems:ayenem_sword")
	public static final Item block = null;
	public AyenemSwordItem(TheUnknownGemsModElements instance) {
		super(instance, 30);
	}
