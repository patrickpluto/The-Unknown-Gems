...
import net.mcreator.theunknowngems.item.EalfenItem;
...
public class EalfenOreBlock extends TheUnknownGemsModElements.ModElement {
	@ObjectHolder("the_unknown_gems:ealfen_ore")
	public static final Block block = null;
	public EalfenOreBlock(TheUnknownGemsModElements instance) {
		super(instance, 65);
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(EalfenItem.block, (int) (1)));
		}
	}
	@SubscribeEvent
