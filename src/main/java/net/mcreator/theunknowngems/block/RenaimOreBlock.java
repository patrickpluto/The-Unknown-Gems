...
import net.mcreator.theunknowngems.item.RenaimItem;
...
public class RenaimOreBlock extends TheUnknownGemsModElements.ModElement {
	@ObjectHolder("the_unknown_gems:renaim_ore")
	public static final Block block = null;
	public RenaimOreBlock(TheUnknownGemsModElements instance) {
		super(instance, 44);
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(RenaimItem.block, (int) (1)));
		}
	}
	@SubscribeEvent
